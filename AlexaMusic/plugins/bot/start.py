...
async def start(client: Client, message: Message):
    await message.reply_photo(
        photo=f"https://te.legra.ph/file/81f1f3a499daabed0ead8.jpg",
        ...
        reply_markup=InlineKeyboardMarkup(
            [[InlineKeyboardButton("🌼 AaYu ᴄʜᴀᴛ 💮", url=f"https://t.me/Royal_frndz")]]
        ),
    )
...
async def start(client: Client, message: Message):
    ...
    await add_served_user(message.from_user.id)
    await message.reply_photo(
        photo=f"https://te.legra.ph/file/c5e7d297a2fcd2f7eb4a6.mp4",
        caption=f"""━━━━━━━━━━━━━━━━━━━━━━━━\n\n✪ **ᴄᴏɴɢʀᴀᴛᴜʟᴀᴛɪᴏɴ** 🎉\n✪ ɴᴏᴡ ʏᴏᴜ ᴀʀᴇ AaYu ᴠᴇʀɪғɪᴇᴅ ᴍᴇᴍʙᴇʀ ɢᴏ ʙᴀᴄᴋ ᴀɴᴅ ᴇɴᴊᴏʏ ᴏᴜʀ sᴇʀᴠɪᴄᴇ ᴀɴᴅ ᴘʟᴀʏ ᴍᴜsɪᴄ 🌼 ..\n\n━━━━━━━━━━━━━━━━━━━━━━━━""",
        reply_markup=InlineKeyboardMarkup(
            [[InlineKeyboardButton("🌼 AaYu ᴄʜᴀᴛ 💮", url=f"https://t.me/Royal_frndz")]]
        ),
    )
